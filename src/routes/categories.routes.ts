...
import { createCategoriesController, listCategoriesController, listCategoriesWithRealEstateController } from "../controllers/categories.controllers";
...
categoriesRoutes.get("/:id/realEstate", ensureIdIsValidMiddlewares, listCategoriesWithRealEstateController)
